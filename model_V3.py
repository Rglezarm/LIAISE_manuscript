...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 16 14:13:54 2023
...
# (4) A-gs parameters can be input in the model
...
class model:
    ...
    def ags(self):
        ...
        # CO2 flux
        self.wCO2A   = An   * (self.mair / (self.rho * self.mco2)) * self.input.cveg
    ...
    def store(self):
        ...
        fac2 = (self.rho*self.mco2)/self.mair
        self.out.CO2[t]        = self.CO2
        self.out.dCO2[t]       = self.dCO2
        self.out.wCO2[t]       = self.wCO2  * fac2
        self.out.wCO2e[t]      = self.wCO2e * fac2
        self.out.wCO2R[t]      = self.wCO2R * fac2
        self.out.wCO2A[t]      = self.wCO2A * fac2
